...
def score_prediction_model(x_train, x_test, y_train, y_test):
...
def main():
    ...
    x_train, x_test, y_train, y_test = prepare_features(cleaned_data)
    best_model, _ = score_prediction_model(x_train, x_test, y_train, y_test)
