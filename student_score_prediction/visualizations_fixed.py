...
Saves plots as image files instead of displaying them
"""
...
def run_all_visualizations():
    ...
    print("\nCreating visualizations and saving them as image files:")
    print("=" * 50)
    ...
    print("You can open these image files to view the graphs.")
